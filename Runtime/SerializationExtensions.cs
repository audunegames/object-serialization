...
namespace Audune.Pickle
{
  ...
  public static class SerializationExtensions
  {
    ...
    public static ObjectState Serialize<TState, TSerializable>(this IReadOnlyDictionary<string, TSerializable> dictionary) where TState : State where TSerializable : IPicklable<TState>
    {
      return dictionary.Serialize(obj => obj.Serialize());
    }
    ...
    {
      return dictionary.Serialize(obj => obj.Serialize(context));
    }
    ...
    public static void Deserialize<TState, TDeserializable>(this IReadOnlyDictionary<string, TDeserializable> dictionary, ObjectState state) where TState : State where TDeserializable : IPicklable<TState>
    {
    ...
    public static void Deserialize<TState, TContext, TDeserializable>(this IReadOnlyDictionary<string, TDeserializable> dictionary, ObjectState state, TContext context) where TState : State where TDeserializable : ISerializable<TState, TContext>
    {
